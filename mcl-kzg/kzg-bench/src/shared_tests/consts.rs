...
pub mod consts_tests {
    ...
    pub const SCALE2_ROOT_OF_UNITYarr: [[u64; 4]; 32] = [
    ...
    pub fn expand_root_of_unityarr(root: &Fr, width: usize) -> Result<Vec<Fr>, String> {
    ...
    fn roots_of_unity_are_plausible_() {
        ...
        unsafe {
            init_globals();
            roots_of_unity_are_plausible::<Fr>(&SCALE2_ROOT_OF_UNITYarr);
        }
    }
    ...
    fn expand_roots_is_plausible_() {
        ...
        unsafe {
            init_globals();
            expand_roots_is_plausible::<Fr>(&SCALE2_ROOT_OF_UNITYarr, &expand_root_of_unityarr);
        }
    }
