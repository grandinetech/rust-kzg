...
mod tests {
    ...
    use arkworks::kzg_proofs::{KZGSettings, generate_trusted_setup, FFTSettings};
    ...
    fn test_fk_multi_settings() {
        fk_multi_settings::<BlstFr, ArkG1, ArkG2, PolyData, FFTSettings, KZGSettings, KzgFK20MultiSettings>(&generate_trusted_setup);
    }
    ...
    fn test_fk_multi_chunk_len_16_16() {
        fk_multi_chunk_len_16_16::<BlstFr, ArkG1, ArkG2, PolyData, FFTSettings, KZGSettings, KzgFK20MultiSettings>(&generate_trusted_setup);
    }
}