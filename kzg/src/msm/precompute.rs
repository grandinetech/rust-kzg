...
#[cfg(all(not(feature = "bgmw"), not(feature = "sppark"), not(feature = "wbits")))]
impl<TFr, TG1, TG1Fp, TG1Affine, TG1ProjAddAffine> EmptyTable<TFr, TG1, TG1Fp, TG1Affine, TG1ProjAddAffine>
where
    TFr: Fr,
    TG1: G1 + G1Mul<TFr> + G1GetFp<TG1Fp>,
    TG1Fp: G1Fp,
...
#[cfg(all(not(feature = "bgmw"), not(feature = "sppark"), not(feature = "wbits")))]
pub type PrecomputationTable<TFr, TG1, TG1Fp, TG1Affine, TG1ProjAddAffine> = EmptyTable<TFr, TG1, TG1Fp, TG1Affine, TG1ProjAddAffine>;
