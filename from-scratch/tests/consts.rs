...
pub mod tests {
    ...
    use kzg_from_scratch::kzg_types::{FFTSettings, Fr};
    ...
    fn roots_of_unity_are_plausible_() {
        roots_of_unity_are_plausible::<Fr>(&SCALE2_ROOT_OF_UNITY);
    }

    #[test]
    fn expand_roots_is_plausible_() {
        expand_roots_is_plausible::<Fr>(&SCALE2_ROOT_OF_UNITY, &expand_root_of_unity);
    }
